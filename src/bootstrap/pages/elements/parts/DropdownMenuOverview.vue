...
import DropdownMenuExample1 from '@bs/pages/elements/examples/DropdownMenuExample1.vue';
import DropdownMenuExample2 from '@bs/pages/elements/examples/DropdownMenuExample2.vue';
import DropdownMenuExample3 from '@bs/pages/elements/examples/DropdownMenuExample3.vue';
import DropdownMenuExample4 from '@bs/pages/elements/examples/DropdownMenuExample4.vue';
import DropdownMenuExample5 from '@bs/pages/elements/examples/DropdownMenuExample5.vue';
import { ref } from 'vue';
...
const contentCls = ['min-h-40 flex items-center', 'p-3 p-md-5'];
</script>

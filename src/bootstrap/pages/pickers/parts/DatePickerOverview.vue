...
import DatePickerExample1 from '@bs/pages/pickers/examples/DatePickerExample1.vue';
import DatePickerExample2 from '@bs/pages/pickers/examples/DatePickerExample2.vue';

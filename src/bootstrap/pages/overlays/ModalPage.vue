...
import ModalUsages from '@bs/pages/overlays/parts/ModalUsages.vue';
...
const linkItems = [
  ...
  },
  {
    ...
    location: { name: 'modal-id', params: { id: 'long-content' } },
  },
  {
    text: 'Hiding Backdrop Overlay',
    location: { name: 'modal-id', params: { id: 'hide-backdrop' } },
  },
] satisfies LinkItem[];
</script>

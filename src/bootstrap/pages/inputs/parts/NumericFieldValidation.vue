...
import NumericFieldExample3 from '@bs/pages/inputs/examples/NumericFieldExample3.vue';
import { ref } from 'vue';
import Example from '../examples/NumericFieldExample3.vue?raw';

...
export function textCssFromOklchColor(value: string) {
  ...
  return Color.lightnessLevel(yiq) > 78 ? 'text-dark' : 'text-light';
}
...
export function IconCircleNodes(props: TRecord): VNode {
  // prettier-ignore
...
export function IconThreeCircle(props: TRecord): VNode {
  // prettier-ignore

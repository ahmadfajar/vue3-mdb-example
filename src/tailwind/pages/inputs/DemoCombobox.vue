        ...
        <div class="col-12 col-lg-10 col-xl-8">
          <div class="mb-3">
            <BsCombobox v-model="employee1" :data-source="peopleSrc1">
              <label class="md:w-35 col-form-label">Field Label</label>
            </BsCombobox>
          </div>
          <div class="mb-3">
            <BsCombobox v-model="employee1" :data-source="peopleSrc1" readonly>
              <label class="md:w-35 col-form-label">State Readonly</label>
            </BsCombobox>
          </div>
          <div class="mb-3">
            <BsCombobox v-model="employee1" :data-source="peopleSrc1" disabled>
              <label class="md:w-35 col-form-label">State Disabled</label>
            </BsCombobox>
          </div>
        </div>
      </div>
        ...
        <div class="col-12 col-lg-10 col-xl-8">
          <div class="mb-3">
            <BsCombobox v-model="employee2" :data-source="peopleSrc1">
              <label class="md:w-35 col-form-label">Classic Field</label>
            </BsCombobox>
          </div>
          <div class="mb-3">

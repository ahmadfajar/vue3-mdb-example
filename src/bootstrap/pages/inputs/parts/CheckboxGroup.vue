...
import CheckboxExample2 from '@bs/pages/inputs/examples/CheckboxExample2.vue';
import CheckboxExample3 from '@bs/pages/inputs/examples/CheckboxExample3.vue';
import CheckboxExample4 from '@bs/pages/inputs/examples/CheckboxExample4.vue';
import { ref, watch } from 'vue';
import type { TRadioInputProps } from 'vue-mdbootstrap';
import Example1 from '../examples/CheckboxExample2.vue?raw';
import Example2 from '../examples/CheckboxExample3.vue?raw';
import Example3 from '../examples/CheckboxExample4.vue?raw';
    ...
    <ShoutBox :tpl="fmtVueTpl" :tsc="fmtVueTsc">
      ...
      <template #content>
        <div :class="contentCls">
          <CheckboxExample3 v-if="sample === 'single-color'" />
          <CheckboxExample4 v-else-if="sample === 'multi-color'" />
          <CheckboxExample2 v-else />
        </div>
      </template>
    </ShoutBox>
  </div>

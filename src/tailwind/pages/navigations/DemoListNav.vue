  ...
  <div class="docs-body mx-auto">
    ...
    <BsAppContainer>
      <div class="demo-block-content bg-gray-200 rounded-xl! mt-3">
        <BsCard class="max-w-100 mx-auto" shadow>
    ...
    <BsAppContainer>
      <div class="demo-block-content bg-gray-200 rounded-xl! mt-3">
        <BsCard class="max-w-100 mx-auto" shadow>
          ...
          <BsListView>
            <BsListNav>
              ...
              <BsListNavItem icon="restaurant" label="Dining">
                <BsListNav child>
                  <BsListNavItem label="Breakfast" />
                  <BsListNavItem label="Sushi" />
                  <BsListNavItem label="Pizza" />
                </BsListNav>
              </BsListNavItem>
              <BsListNavItem icon="school" label="Education">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2">
                    <BsListNav child>
                      <BsListNavItem label="Topic 2.1" />
                      <BsListNavItem label="Topic 2.2" />
                      <BsListNavItem label="Topic 2.3" />
                    </BsListNav>
                  </BsListNavItem>
                  <BsListNavItem label="Topic 3" />
                </BsListNav>
              </BsListNavItem>
              <BsListNavItem icon="people" label="Family">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2" />
                </BsListNav>
              </BsListNavItem>
              <BsListNavItem icon="medication" label="Health">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2" />
                  <BsListNavItem label="Topic 3" />
              ...
              <BsListNavItem icon="warehouse" label="Office">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2" />
                </BsListNav>
              </BsListNavItem>
              <BsListNavItem icon="redeem" label="Promotions">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2">
                    <BsListNav child>
        ...
        <BsCard class="max-w-100 mx-auto mt-3" shadow>
          <BsAppbar class="bg-purple-800" shadow>
            <BsButton color="light" flat icon="menu" mode="icon" />
            <BsAppbarTitle class="text-white" title="Topics" />
            <BsSpacer />
          ...
          <BsListView>
            <BsListNav>
              ...
              <BsListNavItem label="Family">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2" />
                </BsListNav>
              </BsListNavItem>
              <BsListNavItem label="Health">
                <BsListNav child>
                  <BsListNavItem label="Topic 1" />
                  <BsListNavItem label="Topic 2" />
                  <BsListNavItem label="Topic 3" />
    ...
    <BsAppContainer class="bg-gray-400 mt-4 rounded shadow-lg">
      <BsAppbar class="bg-purple-800" clipped-left shadow>
        <BsButton
          color="light"
          flat
          icon="menu"

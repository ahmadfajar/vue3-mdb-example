...
import FontawesomeExample1 from '@bs/pages/icons/examples/FontawesomeExample1.vue';
import FontawesomeExample2 from '@bs/pages/icons/examples/FontawesomeExample2.vue';
import FontawesomeExample3 from '@bs/pages/icons/examples/FontawesomeExample3.vue';
import FontawesomeExample4 from '@bs/pages/icons/examples/FontawesomeExample4.vue';
import { ref } from 'vue';

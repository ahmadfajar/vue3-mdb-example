...
import ChipClickEvents from '@bs/pages/chips/parts/ChipClickEvents.vue';
import ChipDismissible from '@bs/pages/chips/parts/ChipDismissible.vue';
import ChipDropdownMenus from '@bs/pages/chips/parts/ChipDropdownMenus.vue';
import ChipFeatures from '@bs/pages/chips/parts/ChipFeatures.vue';

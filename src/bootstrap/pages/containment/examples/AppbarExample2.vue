<template>
  <BsApp>
    <BsAppbar class="bg-default-color" shadow>
      ...
      <BsAppbarItems>
        ...
        <BsButton color="light" flat icon="notifications_outlined" mode="icon" />
        <BsDropdownMenu class="ms-1" placement="bottom-right" space="3">

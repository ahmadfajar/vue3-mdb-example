...
import IconExample1 from '@bs/pages/icons/examples/IconExample1.vue';
import IconExample2 from '@bs/pages/icons/examples/IconExample2.vue';
import IconExample3 from '@bs/pages/icons/examples/IconExample3.vue';
import IconExample4 from '@bs/pages/icons/examples/IconExample4.vue';
import { ref } from 'vue';
...
const contentCls = ['h-full min-h-40 flex justify-center', 'p-3 p-md-5'];
</script>

...
import ModalExample1 from '@bs/pages/overlays/examples/ModalExample1.vue';
import ModalExample2 from '@bs/pages/overlays/examples/ModalExample2.vue';
import ModalExample3 from '@bs/pages/overlays/examples/ModalExample3.vue';
import ModalExample4 from '@bs/pages/overlays/examples/ModalExample4.vue';
import { ref } from 'vue';

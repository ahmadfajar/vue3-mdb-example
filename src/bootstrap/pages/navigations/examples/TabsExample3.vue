...
<template>
  <BsCard shadow>
    <BsApp style="background-color: inherit">
      ...
      <BsTabs v-model="activeTab" color="bg-indigo-600" variant="material">
        <BsTab label="Home">
        ...
        <BsTab label="Person">
          ...
          assumenda labore aesthetic magna delectus mollit. Keytar helvetica VHS salvia yr.
        </BsTab>
        <BsTab label="Story">
